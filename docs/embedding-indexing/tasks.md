...
| # | Task | Status | Reqs | PR |
|---|---|---|---|---|
| 1 | `CarIndexMapping` gains `description_vector` (knn_vector, dim 384); `CarIndexBootstrap`'s index creation gains `index.knn: true` and `default_pipeline` settings | todo | R1.2 | |
