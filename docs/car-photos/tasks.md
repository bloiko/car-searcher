...
| 2 | `CarSearchResult`/search response includes `photoUrls` | in_progress | R1.1 |
| 3 | Frontend: render first photo (or placeholder) on each result card | in_progress | R1.2, R1.3 |
