...
| # | Task | Status | Reqs | PR |
|---|---|---|---|---|
| 1 | Add `mileage` to `CarSearchResponse.CarSearchResult` and its `.from(Car)` factory; update the stale javadoc that says it's deliberately omitted | in_review | (see acceptance criterion above) | [#16](https://github.com/bloiko/car-searcher/pull/16) |
