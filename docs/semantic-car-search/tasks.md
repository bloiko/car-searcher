...
|---|---|---|---|---|---|
| 1 | `Car` domain model + OpenSearch index mapping (keyword search version) | done | R2.1, R3.1 | [BOH-5](https://linear.app/bohdanloiko/issue/BOH-5) | [#1](https://github.com/bloiko/car-searcher/pull/1) (merged) |
| 2 | `POST /api/cars` — index a listing | todo | R1.1 (enables it) | [BOH-6](https://linear.app/bohdanloiko/issue/BOH-6) | — |
| 3 | `POST /api/cars/search` — placeholder `multi_match` keyword search | todo | R1.1, R1.2, R4.1 | [BOH-7](https://linear.app/bohdanloiko/issue/BOH-7) | — |
| 4 | SvelteKit search page calling the above | todo | R3.1 | [BOH-8](https://linear.app/bohdanloiko/issue/BOH-8) | — |
